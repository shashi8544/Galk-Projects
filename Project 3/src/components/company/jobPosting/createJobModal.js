...
import { createInternshipJobToShow } from "../../../actions/companyActions";
...
const CreateJobModal = ({
	...
	const createJob = (formValues) => {
		...
		createInternshipJobToShow(jobToCreate);
	};
...
export default connect(mapStateToProps, { createInternshipJobToShow })(
	CreateJobModal
);
