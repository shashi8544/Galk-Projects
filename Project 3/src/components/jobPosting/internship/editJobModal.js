...
import { updateInternshipJob } from "../../../actions/internshipJobPostingActions";
...
const EditJobModal = ({
	...
	const updateJob = (formValues) => {
		...
		updateInternshipJob(dataToUpdate);
	};
...
export default connect(mapStateToProps, { updateInternshipJob })(EditJobModal);
