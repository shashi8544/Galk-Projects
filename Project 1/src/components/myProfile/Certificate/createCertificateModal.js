...
import { createStudentCertificate } from "../../../actions/studentAction";
...
const CreateCertificateModal = ({
	...
	const createCertificate = (formValues) => {
		...
		createStudentCertificate(certificateToCreate);
	};
...
export default connect(mapStateToProps, { createStudentCertificate })(
