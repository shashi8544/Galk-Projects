...
const Jobs = ({
  ...
  return (
            ...
            <div className="company_confidence">
              ...
              <div className="likes">
                ...
                >
                  <i
                    style={{ fontSize: "18px" }}
                    className={`fa fa-thumbs-up ${isLiked ? "text-primary" : ""}`}
                  ></i>
                  <div className={`text-dark ${isLiked ? "text-primary" : ""}`} style={{ display: "inline", marginLeft: "5px" }}>
                    Confidence
                  </div>
                </div>
              </div>
    ...
    >
      ...
      <div className="internshipJob_card_description" style={{ color: "black" }}>
        {getText()}
      </div>
    </Card>
  );
